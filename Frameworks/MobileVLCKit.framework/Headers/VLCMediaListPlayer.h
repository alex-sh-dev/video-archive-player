...
@class VLCMedia, VLCMediaPlayer, VLCMediaList, VLCMediaListPlayer, VLCTime;

/**
 *
 */
typedef NS_ENUM(NSInteger, VLCMediaListPlayerState)
{
    VLCMediaListPlayerStateStopped,        ///< Player has stopped
    VLCMediaListPlayerStateOpening,        ///< Stream is opening
    VLCMediaListPlayerStateBuffering,      ///< Stream is buffering
    VLCMediaListPlayerStateEnded,          ///< Stream has ended
    VLCMediaListPlayerStateError,          ///< Player has generated an error
    VLCMediaListPlayerStatePlaying,        ///< Stream is playing
    VLCMediaListPlayerStatePaused,         ///< Stream is paused
    VLCMediaListPlayerStateNothingSpecial
};
 ...
 *
 */
- (void)playItemIndex:(int)index inPosition:(VLCTime *)time;
