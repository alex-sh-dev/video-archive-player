...
/**
 * Stops the thumbnailing process manually
 */
...
/**
 * A dictionary user-specified information
 */
@property (readwrite, strong, nonatomic) NSDictionary *userInfo;

/**
 * Timeout interval for media parsing (in seconds). Default is 10s. timeoutIntervalForMediaParsing <= timeoutIntervalForThumbnailFetching
 */
@property (readwrite, assign, nonatomic) NSTimeInterval timeoutIntervalForMediaParsing;

/**
 * Timeout interval for thumbnail fetching (in seconds). Default is 10s for file, otherwise 45s. timeoutIntervalForMediaParsing <= timeoutIntervalForThumbnailFetching
 */
@property (readwrite, assign, nonatomic) NSTimeInterval timeoutIntervalForThumbnailFetching;

/**
 * Should use a size of video track if possible
 */
@property (readwrite, assign, nonatomic) BOOL shouldUseVideoTrackSizeIfPossible;
