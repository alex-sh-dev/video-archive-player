...
/**
 * EXScrollView extends the functionality of UIScrollView.
...
/**
 * Removes view for zooming from superview
 * @see viewForZooming
 */
- (void)removeViewForZooming;

/*
 * Use this method to force the view to update its layout (reconfigure)
 * These methods will be called inside: setNeedsLayout, layoutIfNeeded
 */
